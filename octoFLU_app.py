...
#            fasttree_path = os.popen("which fasttree").read()
        ...
        self.helpmsg_tc.AppendText("Hello world! Some help messages can go here, eventually connect console output here while octoFLU is running...")
...
if __name__ == '__main__':
    app = wx.App()
    frm = MainFrame(None, title="octoFLU " + version, size=(600,400))
    frm.Show()
    app.MainLoop()
